...
def optimize_parameters_worker(params):
    # Unpack parameters
    data, rsi_entry, rsi_exit, atr_multiplier, reward_ratio, rsi_period, atr_period, adx_period, ema_period = params
    # Execute backtest with provided parameters
    result = backtest(data, rsi_entry, rsi_exit, atr_multiplier, reward_ratio, rsi_period, atr_period, adx_period, ema_period)
